...
import 'package:mit_ocw/features/course/presentation/course_list.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => CourseBloc(RepositoryProvider.of<CourseRepository>(context))
        ...
        body: BlocBuilder<CourseBloc, CourseListState>(
          builder: (context, state) {
            ...
            if (state is CourseListLoadedState) {
              return CourseList(courses: state.courses);
            }
